...
- ONNX Model Zoo SSD-MobileNetV1-12 checkpoint, commit
  ...
  `vibeedit setup --vision` with exact size/SHA-256 verification. This mixed
  notice requires qualified legal review before publication.
...
No third-party recorded media is included in the initial package. All 13
generated preview/audio assets are identified and hash-bound in
`catalog/assets.json`.

This inventory is incomplete until the release-readiness license audit passes.
